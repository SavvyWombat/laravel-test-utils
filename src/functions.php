...
/*
 * These helper functions are intentionally placed in the global namespace for easy access.
 */
...
if (!function_exists('create')) {
    function create(string $class, array $attributes = [], int $number = 1)
    {
...
if (!function_exists('make')) {
    function make(string $class, array $attributes = [], int $number = 1)
    {
        // the factory function always returns a collection if the number parameter is set
        if ($number === 1) {
